package com.heyi.player.core 
{
	...
	import com.heyi.player.interfaces.IMediaPlayerStatus;
	...
	public class MediaPlayStatus extends EventDispatcher implements IMediaPlayerStatus
	{
		...
		public function onNetStatus(evt:flash.events.NetStatusEvent):void
		{
		...
		{
			return (_core&&state!=NOT_START)?_core.getFPS():0.0;
		}
