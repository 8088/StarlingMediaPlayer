package com.heyi.player.events 
{
	...
	public class NetStatusEventCode
	{
		...
		public static const PLAYER_COVER_LOADFAILED:String = "Player.Cover.LoadFailed";
		...
		private static const messageMap:Array =
			...
			, { code:"E1001", message:ARGUMENT_ERROR }
			, { code:"E1002", message:PLAYER_COVER_LOADFAILED }
			, { code:"E1003", message:PLAYER_CORE_LOAD_FAILED }
			, { code:"E1004", message:PLAYER_SKIN_LOAD_FAILED }
			
			, { code:"W1000", message:LANGUAGE_CHANGE_FAILED }
			, { code:"W1100", message:API_INVOKE_FAILED }
			, { code:"W1001", message:RIGHTMENU_CONFIG_LOADFAILED }
